...
export function FocusGroupJoinForm() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    setError(null);
    const res = await fetch("/api/join/focus-group", {
      method: "POST",
  ...
  return (
    <form onSubmit={(e) => void onSubmit(e)} className="space-y-4">
      ...
      <div className="space-y-1">
        <label htmlFor="fg-name" className="text-sm font-medium text-gymsanity-900">
          Name
        </label>
        <input
          id="fg-name"
      ...
      <div className="space-y-1">
        <label htmlFor="fg-email" className="text-sm font-medium text-gymsanity-900">
          Email
        </label>
        <input
          id="fg-email"
      ...
      <div className="space-y-1">
        <label htmlFor="fg-password" className="text-sm font-medium text-gymsanity-900">
          Password
        </label>
        <input
          id="fg-password"

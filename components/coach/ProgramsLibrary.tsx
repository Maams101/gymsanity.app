          ...
          {filtered.map((p) => (
            <li key={p.id}>
              <Link
                ...
                className="group flex h-full flex-col rounded-2xl border border-gymsanity-100 bg-white/90 p-5 shadow-sm transition hover:border-gymsanity-300 hover:shadow-md"
              >
                ...
                <h3 className="mt-3 font-display text-lg font-semibold text-gymsanity-950 group-hover:text-gymsanity-800">
                  {p.title}
                </h3>
                <p className="mt-1 line-clamp-2 flex-1 text-sm text-gymsanity-800/85">{p.description}</p>
                <div className="mt-4 flex flex-wrap items-center justify-between gap-2 border-t border-gymsanity-50 pt-4 text-xs text-gymsanity-700">
                  <span>
                  ...
                  {p.assignedMember ? (
                    ...
                    <span className="font-semibold text-gymsanity-800">Open program →</span>
                  )}
                </div>
              </Link>
            </li>

  ...
  const plans = await Promise.all([
    ...
    prisma.plan.upsert({
      ...
      update: {
        ...
        stripePriceId: process.env.STRIPE_PRICE_SESSIONS_1 || undefined,
      },
      create: {
        slug: "sessions-1",
        name: "1 session",
        ...
        sortOrder: 2,
        billingType: PlanBillingType.ONE_TIME,
        stripePriceId: process.env.STRIPE_PRICE_SESSIONS_1 || null,
      },
    }),
    prisma.plan.upsert({
      where: { slug: "sessions-6" },
      update: {
        name: "6 sessions",
        description: "Six 1:1 coaching sessions. $170 per session.",
        includesDigitalPrograms: true,
        allowsGroupBooking: true,
        allowsOneOnOneBooking: true,
        oneOnOneCreditsPerMonth: 6,
        sortOrder: 3,
        billingType: PlanBillingType.ONE_TIME,
        stripePriceId: process.env.STRIPE_PRICE_SESSIONS_6 || undefined,
      },
      create: {
        slug: "sessions-6",
        name: "6 sessions",
        ...
        sortOrder: 3,
        billingType: PlanBillingType.ONE_TIME,
        stripePriceId: process.env.STRIPE_PRICE_SESSIONS_6 || null,
      },
    }),
    prisma.plan.upsert({
      where: { slug: "sessions-12" },
      update: {
        name: "12 sessions",
        description: "Twelve 1:1 coaching sessions. $165 per session ($5 off).",
        includesDigitalPrograms: true,
        allowsGroupBooking: true,
        allowsOneOnOneBooking: true,
        oneOnOneCreditsPerMonth: 12,
        sortOrder: 4,
        billingType: PlanBillingType.ONE_TIME,
        stripePriceId: process.env.STRIPE_PRICE_SESSIONS_12 || undefined,
      },
      create: {
        slug: "sessions-12",
        name: "12 sessions",
        ...
        sortOrder: 4,
        billingType: PlanBillingType.ONE_TIME,
        stripePriceId: process.env.STRIPE_PRICE_SESSIONS_12 || null,
      },
    }),
    prisma.plan.upsert({
    ...
    prisma.plan.upsert({
      ...
      update: {
        name: "24 sessions",
        description: "Twenty-four 1:1 coaching sessions. $160 per session ($10 off).",
        includesDigitalPrograms: true,
        allowsGroupBooking: true,
        allowsOneOnOneBooking: true,
        oneOnOneCreditsPerMonth: 24,
        sortOrder: 5,
        billingType: PlanBillingType.ONE_TIME,
        stripePriceId: process.env.STRIPE_PRICE_SESSIONS_24 || undefined,
      },
      create: {
        slug: "sessions-24",
        name: "24 sessions",
        ...
        sortOrder: 5,
        billingType: PlanBillingType.ONE_TIME,
        stripePriceId: process.env.STRIPE_PRICE_SESSIONS_24 || null,
      },
    }),
  ]);
